...
export const ContactButtons = () => {
  return (
    <div className="contacts flex justify-center mt-7">
      <div className="buttons text-white font-body flex w-[1372px] h-[167px] bg-gradient-to-r from-[#211E2E] via-[#3A3456] to-[#211E2E] ... rounded-[90px]">
        {/* left */}
        <div className="location flex items-center">
          <img
            src={require("../../img/Location-Icon.png")}
            alt=""
            className="p-0 w-[70px] h-[70px]"
          />
          <div className="span">
